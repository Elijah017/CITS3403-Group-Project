...
class BasicTests(unittest.TestCase):
    def setUp(self):
        ...
        db.create_all()
        user1 = User(username="Bus", email="123456@i.com", password="123")
        user2 = User(username="Car", email="1123ad@a.com", password="1234567890")
        user3 = User(username="Cab", email="113dfsd@a.com", password="asdjojfajiafa")
        user4 = User(username="Truck", email="11edffsd@a.com", password="asfaf143256")
